...
private:
    ...
    void updateAppletsOriginalIconColors();

    QQmlPropertyMap *appletConfiguration(const Plasma::Applet *applet);
...
private:
    ...
    QSet<int> m_iconOverrideConnected;
    QHash<int, QString> m_iconOverrideOriginal;
